...
namespace Main_game.Systems
{
    public class MapGenerator
    {
        ...
        // Находим центр первой созданной нами комнаты и размещаем там игрока
        ...
        // Вырезаем туннель на карте параллельно оси X
        ...
        // Вырезаем туннель на карте параллельно оси Y
